...
namespace WizeTech_Business_CRM.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = WizeTech_Business_CRMConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(WizeTech_Business_CRMDbContext context)
        {
            _context = context;
        }
