...
{
    public abstract class WizeTech_Business_CRMWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static WizeTech_Business_CRMWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(WizeTech_Business_CRMWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<WizeTech_Business_CRMDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<WizeTech_Business_CRMDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<WizeTech_Business_CRMDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<WizeTech_Business_CRMDbContext, Task<T>> func)
        {
            T result;
